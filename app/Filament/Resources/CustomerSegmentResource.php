...
use App\Filament\Resources\CustomerSegmentResource\RelationManagers;
...
{
    protected static ?string $navigationGroup = 'Klienti';

    protected static ?int $navigationSort = 3;

    protected static ?string $navigationLabel = 'Segmenti';
